...
2) В поле Adm нужно указать полный путь к Adm файлy, если его у вас нет тогда: файле запуска указываем такие параметры -dologs -adminlog -AdminLogPlacement -AdminLogBuildActions -netlog а в файле serverDZ.cfg вставляем такие параметры:
